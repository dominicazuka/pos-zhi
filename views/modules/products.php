...
<section class="content">
  ...
  <div class="box">
    ...
    <div class="box-header with-border">
      ...
      <button class="btn btn-warning" data-toggle="modal" data-target="#addProduct">Add Product</button>
...
<div class="modal-dialog">
  ...
  <div class="modal-content">
    ...
    <form role="form" method="POST" enctype="multipart/form-data">
      ...
      <div class="modal-header" style="background: #ff8127; color: #fff">
...
<div class="modal-dialog">
  ...
  <div class="modal-content">
    ...
    <form role="form" method="post" enctype="multipart/form-data">
      ...
      <div class="modal-header" style="background:#ff8127; color:white">

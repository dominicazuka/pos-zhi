...
<head>
  ...
  <title>Zee Holiday Inn Bar Inventory System</title>

  <!-- Tell the browser to be responsive to screen width -->
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">

  <link rel="icon" href="views/img/template/logo.png">
  ...
  <script src="views/bower_components/raphael/raphael.js"></script>
  <script src="views/bower_components/morris.js/morris.js"></script>
